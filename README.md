...
| 2.9    | `openknowledge/ckan-base:2.9`, `openknowledge/ckan-base:2.9.8`    | `openknowledge/ckan-dev:2.9`, `openknowledge/ckan-dev:2.9.8`  | If you need Python 2 images use the `2.9-py2` tags (not recommended) |
