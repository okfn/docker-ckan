...
harvest.gather:
	docker compose $(COMPOSE_FILE_PATH) exec ckan /bin/bash -c "ckan harvester gather-consumer"

harvest.fetch:
	docker compose $(COMPOSE_FILE_PATH) exec ckan /bin/bash -c "ckan harvester fetch-consumer"
